...
public class FicheDescriptive implements Serializable {
    ...
    public  String getAdress() {
        return partenaireNomEntreprise + "<br/>" +
                partenaireAddresse + "<br/>" +
                partenaireEmail + "<br/>" +
                partenaireTelephone + "<br/>" +
                "<b>Representant</b>: " + partenaireRepresentant + "<br/>" +
                "<b>Technique</b>: " +partenaireResponsabletechnique + "<br/>" +
                "<b>Poste</b>: " + partenairePosteCandidat;
                
    }
    
    public String getAdressC() {
        return clientNom + "<br/>" +clientRepresentant + "<br/>" + lieuRealisation;
    }
    @Override
    public String toString() {
        return "net.cofares.FicheDescriptive[ idFicheDescriptive=" + idFicheDescriptive + " ]";
    }
